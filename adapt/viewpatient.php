...
<div class="container" style="margin-top: 5%; width:50%;">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="profilePatientTitle">Patient Profile</h5>
      <form action="delete.php" method="POST">
            <input type="hidden" name="patient_id" id="patient_id" value="<?= $fetch['patient_id']?>">
            <input type="submit" value="Delete Patient" class="btn btn-danger"></input>
      </form>
    </div>
    <div class="modal-body">
      <div class="form-group">
        <div class="row">
          <div class="col">
            ...
            <p class="form-control"><?= $patient_fname?></p>
          </div>
          <div class="col">
            <label for="lastname">Lastname:</label>
            <p class="form-control"><?= $patient_lname?></p>
          </div>
        </div>
      </div>
      <div class="form-group">
        <label for="age">Age:</label>
        <p class="form-control"><?= $patient_age?></p>
      </div>
      <div class="form-group">
        <label for="description">Description:</label>
        <textarea class="form-control" rows="6" readonly><?=$fetch['patient_desc']?></textarea>
      </div>
      <div class="form-group">
        <div class="row">
          <div class="col">
      ...
      <div class="row">
        ...
        <div class="col">
          <form action="location.php" method="POST">
            <input type="hidden" name="patient_id" id="patient_id" value="<?= $fetch['patient_id']?>">
            <input type="submit" value="Check Location" class="btn btn-secondary"></input>
          </form>
        </div>
      </div>
    </div>
...
<div class="modal fade" id="editPatient" tabindex="-1" role="dialog" aria-labelledby="editPatientHeader" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="viewpatient.php" onsubmit="formSubmit(event)" id="patientForm" method="POST">
